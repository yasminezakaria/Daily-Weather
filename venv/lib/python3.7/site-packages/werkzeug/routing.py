...
class Rule(RuleFactory):
    ...
    `string`
        ...
        converter is used which means `string` in the normal settings.py.
...
class Map(object):
    ...
    """The map class stores all the URL rules and some settings.py
    parameters.  Some of the settings.py values are only stored on the
