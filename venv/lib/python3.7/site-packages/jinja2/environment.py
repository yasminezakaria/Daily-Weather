...
class Environment(object):
    ...
    important shared variables like settings.py, filters, tests,
    ...
    def extend(self, **attributes):
        ...
        callbacks and settings.py values without breaking inheritance.
        """
    ...
    def compile_expression(self, source, undefined_to_none=True):
        ...
        in template "settings.py files" or similar situations.
